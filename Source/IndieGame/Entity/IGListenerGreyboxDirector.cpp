...
namespace IGNightHistogram
{
	...
	const FPoint Points[] =
	{
		...
		},
		{
			...
			// 0.18~0.38은 측정값 0.2801에서 저작했는데, 저장소에 커밋된 자산으로는
			// 재현되지 않는다. 같은 소스에서 아트를 다시 구우면 0.2857이 나오고
			// 커밋된 자산 그대로는 0.1155다. 즉 구워진 uasset이 소스보다 오래됐다.
			// 밴드는 클론한 사람이 받는 것, 즉 커밋된 자산 기준으로 둔다. 두 번
			// 돌려 0.1151과 0.1158이었고 편차는 0.0007이다.
			0.02f, 0.22f, 0.010f
		},
		{
