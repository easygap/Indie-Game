[CmdletBinding()]
param([switch]$Interior, [switch]$BakeCctv)
...
if ($fixtureExit -ne 0 -or -not (Select-String -LiteralPath $fixtureLog -Pattern 'FIXTURE_CAPTURE PASS|INTERIOR_CAPTURE PASS') -or
