...
STILLS = (
    "household-before-bed.png",
    "household-before-slipper-low.png",
    "household-after-slipper-low.png",
    "household-before-bowl-close.png",
    "household-after-bowl-close.png",
    "household-before-condenser-front.png",
    "household-after-condenser-front.png",
    "household-after-condenser-side.png",
    "household-after-facade.png",
    "witness-before-pills-close.png",
    "witness-after-pills-close.png",
    "witness-before-butts-close.png",
    "witness-after-butts-close.png",
    "witness-before-roster-close.png",
    "witness-after-roster-close.png",
    ...
    "ux-quiet-1920x1080.png",
    "ux-guide-keyboard-1920x1080.png",
    "entry-before-room.png",
    "entry-room.png",
    "entry-before-desk.png",
    "entry-desk.png",
    "entry-vest-installed.png",
    "entry-labels-front.png",
    "circuit-before-front.png",
    "circuit-front.png",
    "circuit-side.png",
    "circuit-wide.png",
    "circuit-common-off.png",
    "circuit-before-corridor-front.png",
    "circuit-corridor-front.png",
    "circuit-corridor-side.png",
    "booth-before-desk.png",
    "booth-before-pad-complete.png",
    "booth-before-door-prompt.png",
    "booth-desk.png",
    "booth-ledger.png",
    "booth-pad-blank.png",
    ...
    "booth-night-pad-complete.png",
    "spatial-home-entry.png",
    ...
    "roof-stair-up.png",
    "roof-stair-handrail.png",
    "roof-stair-down.png",
    "roof-tank-wide.png",
    "roof-tank-plate.png",
    "roof-tank-side.png",
    "roof-valve-closed.png",
    "roof-valve-open.png",
    "roof-bypass-open.png",
    "roof-circuit-running.png",
    "door-print-before-inside.png",
    "door-print-before-floor.png",
    "door-print-before-neighbor-note.png",
    "door-print-outside.png",
    "door-print-inside.png",
    "door-print-open.png",
    "door-print-floor.png",
    "door-print-calendar.png",
    "door-print-fire-corridor.png",
    "door-print-fire-pilotis.png",
    "door-print-legacy-fire.png",
    "door-print-rental-front.png",
    "door-print-rental-side.png",
    "door-print-neighbor-note.png",
    "finish-before-fire-panel.png",
    "finish-before-alley-brick.png",
    "finish-before-bottle-near.png",
    "finish-before-bottle-far.png",
    "finish-before-extinguisher.png",
    "finish-fire-panel.png",
    "finish-extinguisher.png",
    "finish-bottle-near.png",
    "finish-bottle-far.png",
    "finish-alley-brick.png",
    "finish-store-grout.png",
    "finish-corridor-grout.png",
    "interior-before-window.png",
    "interior-before-pump.png",
    "interior-before-sink.png",
    "interior-window-side.png",
    "interior-pump-panel.png",
    "interior-pump-running.png",
    "interior-pump-fault.png",
    "interior-kitchen-sink.png",
    "interior-sink-drain.png",
    # 승강장 검수 문서도 원본 캡처를 한꺼번에 내려받지 않게 한다.
    "landing-before-mail.png",
    "landing-before-corridor.png",
    "landing-before-neighbor.png",
    "landing-before-pump.png",
    "utility-booth-pump.png",
    "landing-lobby-mail.png",
    "landing-corridor-approach.png",
    "landing-fourth-waiting.png",
    "landing-noticeboard.png",
    "landing-neighbor-doors.png",
