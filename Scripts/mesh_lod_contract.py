...
SMALL_ROUND_CHAINS = {
    # 12~36삼각형 인쇄물은 축약하면 모서리가 무너진다. 거리에 따라 숨긴다.
    "SM_DoorDeliveryMagnet": ((1.0, .20), (1.0, .06), (1.0, .015)),
    "SM_RentalNoticeA4": ((1.0, .20), (1.0, .06), (1.0, .015)),
    "SM_ApartmentCalendar2025": ((1.0, .20), (1.0, .06), (1.0, .015)),
    "SM_NeighborMemo402": ((1.0, .20), (1.0, .06), (1.0, .015)),
