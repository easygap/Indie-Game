...
foreach ($name in @('MeterCounter', 'MeterLabel', 'BoothAgentNote', 'BoothReceipts', 'BoothCalendar')) {
...
foreach ($name in @('M_UtilityStreetBrick', 'M_UtilityVillaBrick', 'M_GraniteTile_XY', 'M_UtilityTankSteel', 'M_UtilityFoundation', 'M_UtilityGraniteCladding', 'M_UtilityConcreteDark', 'M_CctvStandby', 'M_UtilityMeterCounter', 'M_UtilityMeterLabel', 'M_BoothAgentNote', 'M_BoothReceipts', 'M_BoothCalendar')) {
...
foreach ($name in @('T_UtilityTankSteel_D', 'T_CctvStandby_D', 'T_UtilityMeterCounter_D', 'T_UtilityMeterLabel_D', 'T_BoothAgentNote_D', 'T_BoothReceipts_D', 'T_BoothCalendar_D')) {
